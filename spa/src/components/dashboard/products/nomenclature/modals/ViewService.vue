          ...
          <div class="view-nomenclature-header" v-if="mode !== 'create'">
            ...
            <div class="view-nomenclature-header-right">
              <ul class="view-nomenclature-header-actions">
                <li class="view-nomenclature-header-action">Варианты товара</li>
          ...
          <simplebar class="view-nomenclature-main">
            <div class="item-form">
              ...
              <v-row>
                ...
                <v-col cols="3" class="info-table">
                  <div class="item-name">
                    <div class="label-title">минимальная цена услуги</div>
...
import CategoryTree from "../../nomenclature/modals/froms/CategoryTree";
  ...
  methods: {
    ...
    open(itemData, mode) {
      ...
      if (mode === 'create') {
        ...
        this.categoryTree = []
        this.getCategoryTree(this.service.category)
