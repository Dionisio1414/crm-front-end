<template>
    <div>
        ...
        <div class="form-field form-field-period">
            <input type="text" class="field" v-model="dateRange">
            <button type="button" class="form-field-button" @click="isOpenCalendarPeriod = !isOpenCalendarPeriod">
                <span class="icon">
...
export default {
    ...
    data() { 
        return {
            dates: [
                ...[this.list.lists.from.slice(0, 10)], 
                ...[this.list.lists.to.slice(0, 10)]
            ],
