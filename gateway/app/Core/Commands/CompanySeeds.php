...
class CompanySeeds extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'database:company_seeds {edit?} {database?} {connection?}';
    ...
    public function handle()
    {
        try {
            if($this->argument('database')){
                ...
                if($this->argument('edit') && $this->argument('edit') !== 'false'){
                    Config::set('app.edit_seeds', true);
                    Artisan::call('db:seed');
                    Config::set('app.edit_seeds', false);
                }else{
                    Artisan::call('db:seed');
                }
