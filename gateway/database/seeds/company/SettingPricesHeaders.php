...
class SettingPricesHeaders extends Seeder
{
    use SeederCore;

    protected const ITEMS_HEADERS_CSV = '/database/seeds/company/data/setting_prices_headers.csv';
    protected const TABLE_HEADER = 'setting_prices_headers';
