...
class LeadHeaders extends Seeder
{
    use SeederCore;

    protected const ITEMS_HEADERS_CSV = '/database/seeds/company/data/leads_headers.csv';

    protected const TABLE_HEADER = 'leads_headers';
