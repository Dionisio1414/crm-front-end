...
class DocumentPurchasesActivityHeaders extends Seeder
{
    use SeederCore;

    protected const ITEMS_HEADERS_CSV = '/database/seeds/company/data/document_purchases_activity_headers.csv';
    protected const TABLE_HEADER_ITEMS_ = 'document_purchases_activity_headers';
