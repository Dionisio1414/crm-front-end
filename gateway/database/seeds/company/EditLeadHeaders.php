...
class EditLeadHeaders extends Seeder
{
    use SeederCore;

    protected const ITEMS_HEADERS_CSV = '/database/seeds/company/data/edit_lead_headers.csv';

    protected const TABLE_HEADER = 'edit_lead_headers';
