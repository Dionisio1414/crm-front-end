...
class DocumentNomenclatureStockHeaders extends Seeder
{
    use SeederCore;

    protected const ITEMS_HEADERS_CSV = '/database/seeds/company/data/document_nomenclature_stocks_headers.csv';
    protected const TABLE_HEADER = 'document_nomenclature_stock_headers';
