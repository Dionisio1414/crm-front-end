...
class DocumentWriteOffStockHeaders extends Seeder
{
    use SeederCore;

    protected const ITEMS_HEADERS_CSV = '/database/seeds/company/data/document_write_off_stocks_headers.csv';

    protected const TABLE_HEADER = 'document_write_off_stocks_headers';
