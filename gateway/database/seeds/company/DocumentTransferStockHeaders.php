...
class DocumentTransferStockHeaders extends Seeder
{
    use SeederCore;

    protected const ITEMS_HEADERS_CSV = '/database/seeds/company/data/document_transfer_stocks_headers.csv';
    protected const TABLE_HEADER = 'document_transfer_stocks_headers';
