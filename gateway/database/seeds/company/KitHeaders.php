...
class KitHeaders extends Seeder
{
    use SeederCore;

    protected const ITEMS_HEADERS_CSV = '/database/seeds/company/data/kits_headers.csv';
    protected const TABLE_HEADER = 'kits_headers';
