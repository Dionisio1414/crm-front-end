...
class DirectoryEmployees extends Seeder
{
    use SeederCore;

    protected const PATH_CSV_HEADER = '/database/seeds/company/data/directory_employees_headers.csv';

    protected const TABLE_HEADER = 'directory_employees_headers';
