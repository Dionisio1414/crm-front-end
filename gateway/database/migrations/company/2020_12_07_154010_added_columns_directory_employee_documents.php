...
class AddedColumnsDirectoryEmployeeDocuments extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('directory_employee_documents', function (Blueprint $table) {
            ...
            $table->boolean('is_identity_document')->default(0);
            $table->dateTime('document_creation_date')->nullable(true);
