...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'partner_inn' => [
            'unique' => 'ІПН не рідкість',
        ],
        'partner_edrpou' => [
            'unique' => 'ЕДРПОУ не уникальный',
        ],
        'title_company' => [
            'unique' => 'Уже существует',
        ],
        'login' => [
            'required' => 'Email или Телефон обязательны к заполнению'
        ],
        'login_social' => [
            'title'       => 'Под данным email уже есть аккаунт',
            ...
            'provider'    => 'Данная социальная сеть не поддерживается',
        ],
    ],

    /* File Manager */
    'file_manager' => [
        'size' => 'Максимальный размер загружаемого файла 8 МБ',
        'type' => 'Подходящий формат изображений: .jpg, .jpeg, .png, .gif'
    ],
