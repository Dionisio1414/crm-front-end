...
return [
    ...
    */
    ...
    'unique'      => 'Таке значення поля :attribute адреса вже існує.',
    ...
    */
    ...
    'custom' => [
        ...
        'partner_inn' => [
            'unique' => 'ІПН не унікальний',
        ],
        'partner_edrpou' => [
            'unique' => 'ЄДРПОУ не унікальний',
        ],
        'title_company'  => [
            'unique' => 'Вже існує',
        ],
        'login' => [
            'required' => 'Email або Телефон обовязкові до заповнення'
        ],
        'login_social' => [
            'title' => 'По цьому email вже є обліковий запис',
            'title_login' => 'Данный email зарегистрирован не через социальную сеть, авторизируйтесь по паролю и привяжите Вашу социальную сеть',
            'provider'    => 'Дана соціальна мережа не підтримується',
        ]
    ],

    /* File Manager */
    'file_manager' => [
        'size' => 'Максимальний розмір файлу 8 МБ',
        'type' => 'Відповідний формат зображень: .jpg, .jpeg, .png, .gif'
    ],
