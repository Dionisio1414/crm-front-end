...
namespace App\Directories\Repositories\CounterpartiesReturns;

use App\Core\Helpers\TitleJson;
use App\Directories\Models\CounterpartiesReturns\DirectoryCounterpartiesReturn as Model;
use App\Directories\Models\CounterpartiesReturns\DirectoryCounterpartiesReturnsHeader;
 ...
 */
class CounterpartiesReturnsRepository extends CoreRepository
{
    ...
    public function getItemsTable()
    {
        ...
        $data = $this->getTable($data, DirectoryCounterpartiesReturnsHeader::class);
    ...
    public function createItem()
    {
        ...
        $data = $this->changeCellsFormatBd(DirectoryCounterpartiesReturnsHeader::class);
    ...
    public function getItem($id)
    {
        ...
        return $this->getOneTable($item, DirectoryCounterpartiesReturnsHeader::class);
    }
