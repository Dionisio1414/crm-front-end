...
use App\Directories\Models\Positions\DirectoryPosition as Model;
use App\Directories\Models\Positions\DirectoryPositionsHeader;
...
class PositionsRepository extends CoreRepository
{
    ...
    public function getItemsTable()
    {
        ...
        $data = $this->getTable($data, DirectoryPositionsHeader::class);
    ...
    public function createItem()
    {
        ...
        $data = $this->changeCellsFormatBd(DirectoryPositionsHeader::class);
    ...
    public function getItem($id)
    {
        ...
        return $this->getOneTable($item, DirectoryPositionsHeader::class);
    }
