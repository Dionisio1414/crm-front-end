...
use App\Documents\Models\WriteOffStocks\DocumentWriteOffStock as Model;
use App\Documents\Models\WriteOffStocks\DocumentWriteOffStocksHeader;
 ...
 */
class WriteOffStockRepository extends CoreRepository
{
    ...
    public function getItemsTable()
    {
        ...
        $data = $this->getTable($data, DocumentWriteOffStocksHeader::class);
...
//        }
        ...
        $data = [
            ...
            'document_type' => $this->getDirectoryCore('documents', 3),
            'id' => $convert_id,
        ...
        $data = $this->changeCellsCustomFormatBd($data, DocumentWriteOffStocksHeader::class);
        $item->cells()->delete();
    ...
    {
        $item = $this->modelVisible()->find($id);
        return $this->getOneTable($item, DocumentWriteOffStocksHeader::class);
    }
