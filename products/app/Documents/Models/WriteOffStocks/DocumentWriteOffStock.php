...
class DocumentWriteOffStock extends Model
{
    /**
     ...
     * @var array
     */
    protected $fillable = ['id', 'is_default', 'is_editable', 'document_id', 'warehouse_id', 'currency_id', 'responsible_id', 'comments', 'archive', 'receipt_date_actual', 'receipt_date_scheduled', 'organization_id', 'organization_convert_id'];
    ...
    protected $with = ['cells', 'currency', 'responsible' ,'warehouse', 'organization', 'document'];
    ...
    {
        return $this->hasMany(DocumentWriteOffStocksDetail::class, 'write_off_stock_id', 'id');
    }
